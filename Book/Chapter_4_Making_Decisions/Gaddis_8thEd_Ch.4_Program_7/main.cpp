...
int main(int argc, char** argv) {
     ...
     */
     ...
     /*Note:  
     * In this program the programmer forgot to put {}braces after if statement.
     * This means that 
     * cout<<"Congratulations!"<<endl; 
     *        <--Only this statement is conditionally executed. 
     * While, cout<<"That's a high score"<<endl;
     *        cout<<"You deserve a pat on the back"<<endl;
     *        <-- These statements are always excuted in the program. 
     */
