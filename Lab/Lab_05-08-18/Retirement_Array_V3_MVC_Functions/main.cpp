...
void dsply(int nYears, float savReq, int year[], float svBegYr[], float dpEndYr[],
        float inEndYr[]){
...
void rtrmnt(int nYears, float roi, float savReq, int year[], float svBegYr[], float dpEndYr[],
        float inEndYr[]){
    int nYear;
    cout<<fixed<<setprecision(2)<<showpoint;
    cout<<"Year  Year     Savings  Interest   Deposit"<<endl;
